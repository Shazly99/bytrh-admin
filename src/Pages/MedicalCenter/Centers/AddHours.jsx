    ...
    return (
        <Container fluid>
            <div className="app__addprodects">
                {isLang === 'ar' ?
                    <Component.SubNav sub__nav={[{ name: isLang === 'ar' ? 'إضـافـة موعـد' : 'Add Time', path: `/medicalcenter/addHours/${id}`} , { name: isLang === 'ar' ? 'أوقـات العمـل' : 'Medical Center Hours', path: `/medicalcenter/hours/${id}` }]} />
                    :
                    <Component.SubNav sub__nav={[{ name: isLang === 'ar' ? 'أوقـات العمـل' : 'Medical Center Hours', path: `/medicalcenter/hours/${id}` }, { name: isLang === 'ar' ? 'إضـافـة موعـد' : 'Add Time', path: `/medicalcenter/addHours/${id}` }]} />
                }
                                    ...
                                    <div className="app__addprodects-form">
                                        <form onSubmit={registerAddSingleForm}>
                                            ...
                                            <div className='d-flex justify-content-center align-content-center mt-4'>
                                                ...
                                                <div className='baseBtn'>
                                                    <Link to={`/dashboard/medicalcenter/hours/${id}`}>
