...
const MCHours = () => {
    ...
    return (
        ...
        <Container fluid>
            ...
            <div className="app__Users my-3">
                <Component.ButtonBase title={isLang === 'ar' ? 'إضـافـة' : 'Add'} bg={"primary"} icon={<Icons.Add size={21} color={'#ffffffb4'} />} path={`/hours/add`} />
            </div>
