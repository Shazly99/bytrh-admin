              ...
              <div className="row gx-md-3 gx-2 gy-0 d-flex align-items-center">
                ...
                <div className="col-8">
                  <div className="personal-info position-relative">
                    ...
                    <small className='my-0 text-decoration-underline' style={{fontWeight: '500' , cursor: 'pointer' , color: '#2C5DA6'}}>Change Password</small>
                        
                    <Link to={`../editDoctor/${id}`} className="personal-info-edit position-absolute top-0 end-0" style={{color: '#2C5DA6' , cursor: 'pointer' , whiteSpace: 'nowrap'}}>
                  ...
                  <div key={i} className="col-sm-6">
                    ...
                    <div className="price position-relative">
                      ...
                      <div className="service-level d-flex justify-content-between mb-2">
                        ...
                        <h6 className='mb-0 fw-bold pe-2' style={{color: '#2C5DA6'}}>{price.DoctorServiceLevel} SAR</h6>
                      </div>
                      <div className="service-level d-flex justify-content-between">
                        <h6 className='mb-1'>Amount :</h6>
                        <h6 className='mb-0 fw-bold pe-2' style={{color: '#2C5DA6'}}>{price.DoctorPricing} SAR</h6>
                      </div>
                      ...
                      {price.IDDoctorPricing ? 
                        <div className="personal-info-edit position-absolute top-0" onClick={() => {
                          handleShowEdit();
                          setIDDoctorPricing(price.IDDoctorPricing);
                          setAmountEdit(price.DoctorPricing);
                          setDoctorServiceLevelEdit(price.DoctorServiceLevel);
                        }} style={{color: '#2C5DA6' , cursor: 'pointer' , whiteSpace: 'nowrap' , right: '10px'}}>
                          <FiEdit3 className='me-1' />
                          <small className='my-0' style={{fontWeight: '500'}}>Edit</small>
                        </div>
                        :
                        <div className="personal-info-edit position-absolute top-0" onClick={handleShowAdd} style={{color: '#2C5DA6' , cursor: 'pointer' , whiteSpace: 'nowrap' , right: '10px'}}>
                ...
                <div className="col-sm-6">
                  <div className="price position-relative">
                    ...
                    {fetchDoctorMedicalFields.map((field , i) => (
                        <h6 key={i} className='mb-2' style={{color: '#2C5DA6'}}>{field.MedicalFieldName}</h6>
                    ))}

                    <Link to={`../doctorfields/${id}`} className="personal-info-edit position-absolute top-0" style={{color: '#2C5DA6' , cursor: 'pointer' , whiteSpace: 'nowrap' , right: '10px'}}>
                        <FiEdit3 className='me-1' />
                        <small className='my-0' style={{fontWeight: '500'}}>Edit</small>
                    </Link>
                  </div>
                ...
                <div className="col-sm-6">
                  <div className="price position-relative">
                    ...
                    {fetchDoctorAnimalCategories.map((cate , i) => (
                        <h6 key={i} className='mb-2' style={{color: '#2C5DA6'}}>{cate.AnimalCategoryName}</h6>
                    ))}

                    <Link to={`../doctorCategory/${id}`} className="personal-info-edit position-absolute top-0" style={{color: '#2C5DA6' , cursor: 'pointer' , whiteSpace: 'nowrap' , right: '10px'}}>
                        <FiEdit3 className='me-1' />
                        <small className='my-0' style={{fontWeight: '500'}}>Edit</small>
                    </Link>
                  </div>
