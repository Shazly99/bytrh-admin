        ...
        <>
            <Container fluid>
                <div className="app__addprodects">
                    { isLang === 'en' ?
                        <Component.SubNav sub__nav={[{ name: "Doctor Profile", path: `/doctors/doctorProfile/${idDoc}` }, { name: "Edit doctor document ", path: `/doctors/DoctorDocument/${idDoc}/${idDocument}` }]} />
                        :
                        <Component.SubNav sub__nav={[{ name: "الملف الشخصي للطبيب", path: `/doctors/doctorProfile/${idDoc}` }, { name: "تحرير وثيقة الطبيب ", path: `/doctors/DoctorDocument/${idDoc}/${idDocument}` }]} />
                    }
