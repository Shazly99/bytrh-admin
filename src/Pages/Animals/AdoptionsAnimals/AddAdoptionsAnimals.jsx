  ...
  return (
    <Container fluid>
      <div className="app__addprodects">
        {isLang === 'ar' ?
          <Component.SubNav sub__nav={[{ name: "إضافـة فئـة", path: '/animals/adoptionsSubcategories/addsubcategories' }, { name: "قائمــة الفئـات الفرعيـة", path: '/animals/adoptionsSubcategories' }]} />
          :
          <Component.SubNav sub__nav={[{ name: "Adoption Categories", path: '/animals/adoptionsSubcategories' }, { name: "Add Adoption Categories ", path: '/animals/adoptionsSubcategories/addsubcategories' }]} />
        }
...
export default AddAdoptionsAnimals