  ...
  async function editCategory(category) {
    await PostData(`${process.env.REACT_APP_API_URL}/admin/animalsubcategories/edit`, category, apiheader).then((res) => {
      ...
      if (res.data.Success === true) { 
        ...
        setTimeout(() => {
          navigate('/animals/adoptionsSubcategories');
        }, 2000);
      } else {
  ...
  return (
    <Container fluid>
      <div className="app__addprodects">
        ...
        {isLang === 'ar' ?
            <Component.SubNav sub__nav={[{ name: " تعديل الفئـة الفرعيــة", path: `/animals/adoptionsSubcategories/editsubcategories/${id}` } , { name: "قائمـة الفئـات الفرعيـة", path: '/animals/adoptionsSubcategories' }]} />
            :
            <Component.SubNav sub__nav={[{ name: "Adoption Categories", path: '/animals/adoptionsSubcategories' }, { name: "Edit Adoption  ", path: `/animals/adoptionsSubcategories/editsubcategories/${id}` }]} />
        }
...
export default EditAdoptionsAnimals